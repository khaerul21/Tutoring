            ...
            <tbody>
                @foreach ($content as $content)
                    <tr class="bg-white border-b hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <a href="#" class="font-medium text-blue-600 hover:underline">Edit Content</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
...
<div class='container  flex flex-wrap flex-grow mx-auto mt-10 mb-10 justify-center items-center'>
    ...
    <a href="{{route('admin-manage-courses')}}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
        Save Course
