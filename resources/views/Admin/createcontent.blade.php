        ...
        <div class="mt-10">
            <section class="bg-white">
                <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                    ...
                    <form method='POST' action="{{route('admin-save-content')}}">
                        @csrf
                        ...
                        <a href="{{route('admin-confirmation', ['id' => $idcourse])}}" class="inline-flex items-center px-3 py-2 text-sm font-medium justify-endtext text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                            Next
