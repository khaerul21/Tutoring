                        ...
                        <form method='POST' action="{{ route('student-usercourse.store') }}">
                            ...
                            @if (now() <= $course->start_date)
                                <button type="{{ route('student-usercourse.store') }}"
                                    class=" mt-10 inline-flex items-center py-2.5 px-3 ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                                    + Add Course
                                </button>
                            @else
