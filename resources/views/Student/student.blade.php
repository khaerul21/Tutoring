     ...
     <div class="flex items-center justify-between">
       <div class="flex items-center justify-start rtl:justify-end">
         ...
         <a href="https://flowbite.com" class="flex ms-2 md:me-24">
           ...
           <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap">erulcapek</span>
         </a>
       </div>
 ...
 <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
       <ul class="space-y-2 font-medium">
          ...
          <li>
             <a href="{{route('student-usercourses')}}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
          ...
          <li>
             <a href="{{route('student-courses')}}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
          ...
          <li>
            <form method="POST" action="{{ route('logout') }}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
               ...
               <a href="route('logout')" onclick="event.preventDefault();
                  this.closest('form').submit();" class="flex-1 ms-3 whitespace-nowrap">
                  Log Out
               </a>
            </form>
          </li>
