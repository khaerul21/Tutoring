...
<div class=" m-4">
    <div class="m-3 flex items-cter justify-center">
        ...
        @foreach ($courses as $course)
            <div class="max-w-sm m-10 bg-white border border-gray-200 rounded-lg shadow">
                <div class="p-5">
                    ...
                    <p class="mb-3 font-normal text-gray-700">Course By {{$course->name}}</p>
                    <div class="w-full bg-gray-200 rounded-full h-2.5">
                        <div class="bg-blue-600 h-2.5 rounded-full" style="width: 45%"></div>
                    </div>
                    <div class="container flex flex-wrap mx-auto  justify-center items-center">
                    <a href="{{ route('learning-page', $course->id) }}" class="m-4 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                       Learn Now
                    </a>
                    </div>
                </div>
