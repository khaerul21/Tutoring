    ...
    <div class="container flex flex-wrap mx-auto mt-10 mb-10 justify-center items-center">
        @if (count($courses) > 0)
            @foreach ($courses as $course)
                <div
                    class="max-w-sm m-10 bg-white border border-gray-200 rounded-lg shadow">
                    <div class="p-5">
                        <a href="#">
                        ...
                        <div class="container flex flex-wrap mx-auto  justify-center items-center">
                            <a href="{{ route('teacher-course-detail', ['idcourse' => $course->id]) }}"
                                class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                                Read more
                            </a>
                            <a href="{{ route('teacher-course.edit', ['course' => $course->id]) }}"
                                class="m-4 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                                Edit
                            </a>
                            <form action="{{ route('teacher-course.destroy', $course->id) }}" method="POST"
