...
<div class="w-100 h-100">
            <section class="bg-white">
                <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                    <h2 class="mb-4 text-xl font-bold text-gray-900 flex items-center justify-center">Create New Course</h2>
                    <form method="POST" action="{{ route('teacher-course.update', $data[0]->id) }}">
                        @method("PUT")
                        @csrf
                        ...
                        <div class="sm:col-span-2 mt-4">
                            ...
                            <textarea id="description" name="description" rows="8" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500" placeholder="Your description here">{{ $data[0]->description}}</textarea>
