        ...
        <div class="mt-10">
            <section class="bg-white">
                <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                    <h2 class="mb-4 text-xl font-bold text-gray-900 flex items-center justify-center">Add Content</h2>

                    <form method='POST' action="{{route('teacher-content.store')}}">
                        @csrf
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <input type="text" name="course_id" id="course_id" class="hidden bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Type product name" value="{{$idcourse}}" required="">
                        </div>
                        <button type="{{route('teacher-content.store')}}" class=" mt-10 inline-flex items-center py-2.5 px-3 ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                            Add Content
                        </button>
                        <a href="{{route('teacher-confirmation', ['id' => $idcourse])}}" class="inline-flex items-center px-3 py-2 text-sm font-medium justify-endtext text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                            Next
