...
<div class="top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" style="margin: 150px 100px 0px 500px">
    <h1 class="flex flex-wrap font-extrabold leading-none tracking-tight text-gray-900 justify-center items-center md:text-5xl lg:text-6xl">{{$course->course_name}}</h1>
</div>
...
<div class="container flex flex-wrap mx-auto mb-10 justify-center items-center" >
    ...
    <a href="{{ route('teacher-add-content', ['idcourse' => $course->id]) }}" class="m-4 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
        + Add New Content
    </a>;
</div>
                    ...
                    @foreach ($content as $content)
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="flex px-6 py-4">
                                <a href="{{route('teacher-content.edit', $content->id)}}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">Edit Content</a>
